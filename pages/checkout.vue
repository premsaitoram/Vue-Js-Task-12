                ...
                <div class="md:flex gap-4 justify-between mx-auto w-full">
                    <div class="md:w-[65%]">
                        ...
                        <div id="Items" class="bg-white rounded-lg p-4 mt-4">
                            <div v-for="product in useStore.checkout" :key="product.id">
                    ...
                    <div class="md:w-[35%]">
                        ...
                        <div class="bg-white rounded-lg p-4 mt-4">
                            <div class="text-lg font-semibold mb-2 mt-2">Ecommerce</div>
                            <p class="my-2">
                                Ecommerce shop keeps your information and payment safe
                            </p>
